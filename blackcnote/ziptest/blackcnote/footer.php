            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="footer-widget">
                        ...
                        <?php else : ?>
                            <h3 class="h5 mb-3"><?php esc_html_e('Quick Links', 'hyip-theme'); ?></h3>
                            <?php
                            wp_nav_menu([
                ...
                <div class="col-md-4">
                    <div class="footer-widget">
                        ...
                        <?php else : ?>
                            <h3 class="h5 mb-3"><?php esc_html_e('Contact Us', 'hyip-theme'); ?></h3>
            ...
            <div class="row">
                <div class="col-md-6">
                    <p class="mb-0 text-muted">
                        ...
                        <?php esc_html_e('All rights reserved.', 'hyip-theme'); ?>
                    </p>
                </div>
