    ...
    constructor() {
        this.config = {
            ...
            wordpress: {
                ...
                adminUrl: process.env.WORDPRESS_ADMIN_URL || 'http://localhost/wp-admin',
                apiUrl: process.env.WORDPRESS_API_URL || 'http://localhost/wp-json',
                port: 80,
                ssl: false
            },
            ...
            watch: {
                patterns: [
                    'wp-content/themes/blackcnote/**/*.php',
                    'wp-content/themes/blackcnote/**/*.css',
                    'wp-content/themes/blackcnote/**/*.js',
                    'wp-content/themes/blackcnote/**/*.html',
                    'hyiplab/**/*.php',
                    'src/**/*.tsx',
                    'src/**/*.ts',
                    'src/**/*.css',
