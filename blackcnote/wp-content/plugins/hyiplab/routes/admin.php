...
$router->router([
    ...
    'admin.deposit.pending' => [
        ...
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'pending'],
    ],
    'admin.deposit.approved' => [
        'method'       => 'get',
        'query_string' => 'deposit_approved',
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'approved'],
    ],
    'admin.deposit.successful' => [
        'method'       => 'get',
        'query_string' => 'deposit_successful',
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'successful'],
    ],
    'admin.deposit.rejected' => [
        'method'       => 'get',
        'query_string' => 'deposit_rejected',
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'rejected'],
    ],
    'admin.deposit.initiated' => [
        'method'       => 'get',
        'query_string' => 'deposit_initiated',
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'initiated'],
    ],
    'admin.deposit.list' => [
        'method'       => 'get',
        'query_string' => 'deposit_list',
        'middleware'   => ['checkPlugin'],
        'action'       => [DepositController::class, 'index', 'all'],
    ],
    ...
    'admin.withdraw.pending' => [
        ...
        'middleware'   => ['checkPlugin'],
        'action'       => [WithdrawalController::class, 'index', 'pending'],
    ],
    'admin.withdraw.approved' => [
        'method'       => 'get',
        'query_string' => 'withdraw_approved',
        'middleware'   => ['checkPlugin'],
        'action'       => [WithdrawalController::class, 'index', 'approved'],
    ],
    'admin.withdraw.rejected' => [
        'method'       => 'get',
        'query_string' => 'withdraw_rejected',
        'middleware'   => ['checkPlugin'],
        'action'       => [WithdrawalController::class, 'index', 'rejected'],
    ],
    'admin.withdraw.log' => [
        'method'       => 'get',
        'query_string' => 'withdraw_log',
        'middleware'   => ['checkPlugin'],
        'action'       => [WithdrawalController::class, 'index', 'all'],
    ],
    ...
    'admin.ticket.index' => [
        ...
        'middleware'   => ['checkPlugin'],
        'action'       => [SupportTicketController::class, 'index', 'all'],
    ],
    'admin.ticket.pending' => [
        'method'       => 'get',
        'query_string' => 'ticket_pending',
        'middleware'   => ['checkPlugin'],
        'action'       => [SupportTicketController::class, 'index', 'pending'],
    ],
    'admin.ticket.closed' => [
        'method'       => 'get',
        'query_string' => 'ticket_closed',
        'middleware'   => ['checkPlugin'],
        'action'       => [SupportTicketController::class, 'index', 'closed'],
    ],
    'admin.ticket.answered' => [
        'method'       => 'get',
        'query_string' => 'ticket_answered',
        'middleware'   => ['checkPlugin'],
        'action'       => [SupportTicketController::class, 'index', 'answered'],
    ],
    'admin.ticket.view' => [
        'method'       => 'get',
    ...
    'admin.users.active' => [
        ...
        'middleware'   => ['checkPlugin'],
        'action'       => [UserController::class, 'index', 'active'],
    ],
    'admin.users.banned' => [
        'method'       => 'get',
        'query_string' => 'users_banned',
        'middleware'   => ['checkPlugin'],
        'action'       => [UserController::class, 'index', 'banned'],
    ],
    'admin.users.kyc_pending' => [
        'method'       => 'get',
        'query_string' => 'users_kyc_pending',
        'middleware'   => ['checkPlugin'],
        'action'       => [UserController::class, 'index', 'kyc_pending'],
    ],
    'admin.users.kyc_unverified' => [
        'method'       => 'get',
        'query_string' => 'users_kyc_unverified',
        'middleware'   => ['checkPlugin'],
        'action'       => [UserController::class, 'index', 'kyc_unverified'],
    ],
    'admin.users.detail' => [
        'method'       => 'get',
    ...
    'admin.users.add_sub_balance' => [
        'method'       => 'post',
        'query_string' => 'users_add_sub_balance',
        'middleware'   => ['checkPlugin'],
