...
<div class="plans">
    ...
    <div class="row mb-5">
        <div class="col-lg-6 mx-auto">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php esc_html_e('Investment Calculator', 'hyip-theme'); ?></h5>
                    <form id="investment-calculator" class="needs-validation" novalidate>
                        <div class="mb-3">
                            <label for="plan_id" class="form-label">
                                <?php esc_html_e('Select Plan', 'hyip-theme'); ?>
                            </label>
                            <select class="form-select" id="plan_id" name="plan_id" required>
                                <option value=""><?php esc_html_e('Choose a plan...', 'hyip-theme'); ?></option>
                            ...
                            <div class="invalid-feedback">
                                <?php esc_html_e('Please select a plan.', 'hyip-theme'); ?>
                            </div>
                        </div>

                        <div class="mb-3">
                            <label for="amount" class="form-label">
                                <?php esc_html_e('Investment Amount', 'hyip-theme'); ?>
                            </label>
                            <div class="input-group">
                                ...
                                <input type="number" 
                                       ...
                                       required>
                                <div class="invalid-feedback">
                                    <?php esc_html_e('Please enter a valid amount.', 'hyip-theme'); ?>
                                </div>
                            </div>
                        </div>

                        <button type="submit" class="btn btn-primary w-100">
                            <?php esc_html_e('Calculate Return', 'hyip-theme'); ?>
                        </button>
                    </form>
                    ...
                    <div id="calculator-result" class="mt-4 d-none">
                        <div class="alert alert-info">
                            <h6 class="alert-heading">
                                <?php esc_html_e('Estimated Return', 'hyip-theme'); ?>
                            </h6>
                            <p class="mb-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center my-4">
                            ...
                            <p class="text-muted mb-0">
                                <?php esc_html_e('Return Rate', 'hyip-theme'); ?>
                            </p>
                        </div>
                        <ul class="list-unstyled">
                            <li class="mb-2">
                                ...
                                printf(
                                    ...
                                    esc_html__('Duration: %d days', 'hyip-theme'),
                                    $plan->duration
                                );
                                ?>
                            </li>
                            <li class="mb-2">
                                ...
                                printf(
                                    ...
                                    esc_html__('Min. Investment: %s', 'hyip-theme'),
                            ...
                            <li>
                                ...
                                printf(
                                    ...
                                    esc_html__('Max. Investment: %s', 'hyip-theme'),
