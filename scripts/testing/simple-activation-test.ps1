...
<#
.SYNOPSIS
    Simple BlackCnote System Activation Test
.DESCRIPTION
...
Write-Host "`n🔍 BLACKCNOTE AUTOMATED ACTIVATION TEST" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING CANONICAL PATHS" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING DOCKER SERVICES" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING WORDPRESS CONFIGURATION" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING THEME ACTIVATION" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING PLUGIN ACTIVATION" -ForegroundColor Magenta
...
# Test 7: React App
Write-Host "`n🔍 TESTING REACT APP" -ForegroundColor Magenta
...
Write-Host "`n🔍 TESTING REST API ENDPOINTS" -ForegroundColor Magenta
$apiEndpoints = @(
    "wp-json/wp/v2/posts",
    "wp-json/wp/v2/pages", 
