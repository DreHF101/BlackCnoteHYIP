                    ...
                    <table class="table table--light style--two">
                        <thead>
                            ...
                            <th><?php esc_html_e('User', HYIPLAB_PLUGIN_NAME); ?></th>
                                ...
                                <th><?php esc_html_e('Start Date', HYIPLAB_PLUGIN_NAME); ?></th>
                                <th><?php esc_html_e('End Date', HYIPLAB_PLUGIN_NAME); ?></th>
                                <th><?php esc_html_e('Status', HYIPLAB_PLUGIN_NAME); ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php foreach ($stakingInvests->data as $invest) { 
                                ...
                                <tr>
                                    ...
                                    <td> <?php echo esc_html(hyiplab_show_amount($invest->interest)); ?></td>
                                    <td> 
                                        <?php echo hyiplab_show_amount($invest->interest + $invest->invest_amount); ?>
                                    </td>
                                    <td>
                                        <?php echo esc_html(hyiplab_show_date_time($invest->created_at)); ?>
                                    </td>
                                    <td>
                                        <?php echo esc_html(hyiplab_show_date_time($invest->end_at)); ?>
                                    </td>
                                    <td>
                            ...
                            <?php } ?>
                            <?php if (hyiplab_check_empty($stakingInvests->data)) { ?>
                                <tr>
