    ...
    <header id="masthead" class="site-header bg-light">
        <nav class="navbar navbar-expand-lg navbar-light">
            <div class="container">
                <div class="site-branding">
                    ...
                    if (file_exists(get_template_directory() . '/assets/img/header-logo.png')) : ?>
                        <a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
                            <img src="<?php echo esc_url(get_template_directory_uri() . '/assets/img/header-logo.png'); ?>" alt="<?php bloginfo('name'); ?> Logo" class="img-fluid" style="max-height:60px;">
                        </a>
                    <?php else : ?>
                        <h1 class="site-title">
                            <a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
                ...
                <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#primary-menu" aria-controls="primary-menu" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'blackcnote'); ?>">
                    ...
                    <?php if (is_user_logged_in()) : ?>
                        <div class="ms-lg-3">
                            <a href="<?php echo esc_url(home_url('/dashboard')); ?>" class="btn btn-primary">
                                <?php esc_html_e('Dashboard', 'blackcnote'); ?>
                            </a>
                        </div>
                    <?php else : ?>
                        <div class="ms-lg-3">
                            ...
                            <a href="<?php echo esc_url(home_url('/register')); ?>" class="btn btn-primary">
                                <?php esc_html_e('Register', 'blackcnote'); ?>
                            </a>
                        </div>
                    <?php endif; ?>
                </div>
