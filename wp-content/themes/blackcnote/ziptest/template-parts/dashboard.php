...
$earnings = $wpdb->get_var($wpdb->prepare(
    "SELECT SUM(amount) FROM {$wpdb->prefix}blackcnote_transactions 
...
<div class="dashboard">
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php esc_html_e('Total Balance', 'blackcnote-theme'); ?></h5>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php esc_html_e('Total Earnings', 'blackcnote-theme'); ?></h5>
                    <p class="card-text h3">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo esc_url(home_url('/withdraw')); ?>" class="btn btn-outline-primary">
                            <?php esc_html_e('Withdraw', 'blackcnote-theme'); ?>
                        </a>
                        <a href="<?php echo esc_url(home_url('/profile')); ?>" class="btn btn-outline-secondary">
                            <?php esc_html_e('Edit Profile', 'blackcnote-theme'); ?>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php esc_html_e('Return Rate', 'blackcnote-theme'); ?></th>
                                        <th><?php esc_html_e('Start Date', 'blackcnote-theme'); ?></th>
                                        <th><?php esc_html_e('End Date', 'blackcnote-theme'); ?></th>
                    ...
                    <?php else : ?>
                        <p class="text-muted mb-0">
                            <?php esc_html_e('No active investments found.', 'blackcnote-theme'); ?>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <?php if ($transactions) : ?>
                        ...
                        <div class="text-end mt-3">
                            <a href="<?php echo esc_url(home_url('/transactions')); ?>" class="btn btn-link">
