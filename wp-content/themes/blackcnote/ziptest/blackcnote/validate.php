...
class BlackCnote_Theme_Validator {
    ...
    private array $required_functions = [
        ...
        'blackcnote_filter_transactions'
    ];
    ...
    private array $required_shortcodes = [
        'blackcnotelab_dashboard',
        'blackcnotelab_plans',
        'blackcnotelab_transactions'
    ];
    ...
    private array $required_hooks = [
        ...
        'widgets_init',
        'customize_register',
        'blackcnotelab_before_dashboard',
        'blackcnotelab_after_dashboard',
        'blackcnotelab_before_plans',
        'blackcnotelab_after_plans',
        'blackcnotelab_before_transactions',
        'blackcnotelab_after_transactions'
    ];
    ...
    public function validate(): void {
        ...
        $this->check_blackcnotelab_integration();
    }
    ...
    /**
     * Check BlackCnotelab integration
     */
    private function check_blackcnotelab_integration(): void {
        // Check if BlackCnotelab plugin is active
        if (!is_plugin_active('blackcnotelab/blackcnotelab.php')) {
            error_log('BlackCnotelab plugin is not active');
            return;
        }

        // Check for required BlackCnotelab functions
        $required_blackcnotelab_functions = [
            'blackcnotelab_get_plans',
            'blackcnotelab_get_transactions',
            'blackcnotelab_calculate_return'
        ];

        foreach ($required_blackcnotelab_functions as $function) {
            if (!function_exists($function)) {
                error_log("Missing required BlackCnotelab function: {$function}");
            }
        }

        // Check for required BlackCnotelab hooks
        $required_blackcnotelab_hooks = [
            'blackcnotelab_before_dashboard',
            'blackcnotelab_after_dashboard',
            'blackcnotelab_before_plans',
            'blackcnotelab_after_plans',
        ...
        foreach ($required_blackcnotelab_hooks as $hook) {
            if (!has_action($hook)) {
