...
echo [INFO] Navigating to canonical BlackCnote directory...
cd /d "C:\Users\CASH AMERICA PAWN\Desktop\BlackCnote"
...
if not exist "docker-compose.yml" (
    ...
    echo [ERROR] Please ensure you're in the BlackCnote directory
    pause
    exit /b 1
)

echo ✓ Successfully navigated to canonical BlackCnote directory
echo.
