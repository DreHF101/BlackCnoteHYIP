...
<div class="card mb-4">
    <form action="<?php echo hyiplab_route_link('admin.gateway.manual.update'); ?>&amp;id=<?php echo intval($method->id); ?>" method="POST" enctype="multipart/form-data">
        <?php hyiplab_nonce_field('admin.gateway.manual.update'); ?>
        <div class="card-body">
                        ...
                        <div class="col-xl-5 col-md-12">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="any" class="form-control" name="rate" value="<?php echo esc_attr(hyiplab_get_amount($gatewayCurrency->rate)); ?>" required />
                    ...
                    <div class="row">
                            ...
                            <div class="card border--primary mt-3">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" class="form-control" name="min_limit" value="<?php echo esc_attr(hyiplab_get_amount($gatewayCurrency->min_amount)); ?>" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" class="form-control" name="max_limit" value="<?php echo esc_attr(hyiplab_get_amount($gatewayCurrency->max_amount)); ?>" required />
                                            <div class="input-group-text"><?php echo hyiplab_currency('text'); ?></div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="card border--primary mt-3">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" class="form-control" name="fixed_charge" value="<?php echo esc_attr(hyiplab_get_amount($gatewayCurrency->fixed_charge)); ?>" required />
                                            <div class="input-group-text"><?php echo hyiplab_currency('text'); ?></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" step="any" class="form-control" name="percent_charge" value="<?php echo esc_attr(hyiplab_get_amount($gatewayCurrency->percent_charge)); ?>" required>
                        ...
                        <div class="col-lg-12">
                            <div class="card border--primary mt-3">
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea rows="8" class="form-control border-radius-5 nicEdit" name="instruction"><?php echo balanceTags(wp_kses($method->description, hyiplab_allowed_html())); ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
