...
CREATE TABLE `{{prefix}}hyiplab_invests` (
  ...
  `rem_compound_times` int NOT NULL DEFAULT '0',
...
CREATE TABLE `{{prefix}}hyiplab_notification_templates` (
  ...
  `firebase_body` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) {{collate}};

INSERT INTO `{{prefix}}hyiplab_notification_templates` (`id`, `act`, `name`, `subj`, `email_body`, `sms_body`, `shortcodes`, `email_status`, `sms_status`, `firebase_status`, `firebase_body`, `created_at`, `updated_at`) VALUES
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_stakings;
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_staking_invests;
...
DROP TABLE IF EXISTS {{prefix}}hyiplab_promotion_tools;
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_pools;
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_pool_invests;
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_holidays;
CREATE TABLE `{{prefix}}hyiplab_holidays` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
--
DROP TABLE IF EXISTS {{prefix}}hyiplab_schedule_invests;
