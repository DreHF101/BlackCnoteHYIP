...
$excludePatterns = @(".git", ".gitignore", "package.ps1", "package.sh", "*.log", "*.zip", "ziptest")
...
Write-Host "BlackCnote Theme packaged successfully: $zipFile"
Write-Host "`nTheme packaging completed successfully!"
Write-Host "Ready for deployment to WordPress.com or GitHub!" 