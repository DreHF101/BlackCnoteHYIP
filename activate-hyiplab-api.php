...
$endpoints = array(
    'status' => 'http://wordpress/wp-json/hyiplab/v1/status',
    'plans' => 'http://wordpress/wp-json/hyiplab/v1/plans',
    'stats' => 'http://wordpress/wp-json/hyiplab/v1/stats',
    'health' => 'http://wordpress/wp-json/hyiplab/v1/health'
);
...
$cors_response = wp_remote_get('http://wordpress/wp-json/hyiplab/v1/status', array(
    'timeout' => 10,
    'headers' => array(
        'X-WP-Nonce' => wp_create_nonce('wp_rest')
    )
...
echo "\n=== Test Summary ===\n";
echo "WordPress URL: http://wordpress\n";
echo "Admin URL: http://wordpress/wp-admin/\n";
echo "API Base URL: http://wordpress/wp-json/hyiplab/v1/\n";
